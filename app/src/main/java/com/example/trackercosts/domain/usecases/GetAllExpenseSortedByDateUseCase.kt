...
//
//class GetAllExpenseSortedByDateUseCase @Inject constructor(private val expenseRepository: ExpenseRepository) {
//    suspend operator fun invoke() : List<Expense> {
//        return expenseRepository.getAllExpenseSortedByDate()
//    }
//}